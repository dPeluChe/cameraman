...
public actor ProxyGenerator {
    ...
    public struct Configuration: Sendable {
        ...
        /// Video codec for proxy (H.264 recommended for compatibility)
        public let codec: AVVideoCodecType
        /// Output format (.mov for compatibility)
        public let outputFormat: AVFileType
        /// Target bitrate in Mbps (lower = smaller file size)
        public let targetBitrate: Int
        /// Whether to preserve aspect ratio
        public let preserveAspectRatio: Bool
        /// Frame rate for proxy (lower = smaller file, less smooth)
        ...
        /// Default 720p proxy configuration
        public static let `default` = Configuration()

        /// High-quality proxy (1080p)
        ...
        /// Low-quality proxy (480p) for very large files
    ...
    public struct ProxyResult: Sendable {
        ...
        /// Duration of proxy (seconds)
        public let duration: TimeInterval
        /// Size of proxy file (bytes)
