...
- [ ] **Hide real cursor at capture + keystroke overlay** — remaining synthetic-cursor work: hide/mask the system cursor during recording and add a Keycastr-style keystroke overlay from `keys.jsonl`.
