...
- [ ] (P0) Permisos y "health checks": screen recording permission, mic permission, camera permission
...
- [ ] (P0) `EditorModel` no destructivo: trim in/out, cut segments (modelo basado en segments, no edits)
...
- [ ] (P0) Definir `overlays[]` en `project.json` + helpers CRUD
...
- [ ] (P0) `ExportEngine` job: render final con trims/cuts/layouts/overlays, downscale de resolución nativa a 1080p, preset `web_1080_h264`
- [ ] (P0) Progreso + cancelación + logs estructurados
- [ ] (P1) Presets adicionales: HEVC, calidad alta (4K)
